...
class DeveloperNotificationsRepository extends Repository
{
    ...
    const SUBSCRIPTION_PRICE_CHANGE_UPDATED = 19;
    const SUBSCRIPTION_PENDING_PURCHASE_CANCELED = 20;
    const SUBSCRIPTION_PRICE_STEP_UP_CONSENT_UPDATED = 22;
    ...
    const NOTIFICATION_TYPES = [
        ...
        self::SUBSCRIPTION_PRICE_CHANGE_UPDATED,
        self::SUBSCRIPTION_PENDING_PURCHASE_CANCELED,
        self::SUBSCRIPTION_PRICE_STEP_UP_CONSENT_UPDATED,
    ];
